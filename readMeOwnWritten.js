...
// and also we need to install concurrently, so server will goes up on 5000 and react goes on 3000 port by default,but in the same time
...
// so we should go to package.json and add proxy ->
