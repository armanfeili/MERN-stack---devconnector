            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  // whenever we check the box, disabled will change,so at first, disabled is set to false...
                  // by clicking the check box, disabled in state component, will change, so this field will be disable, so we can't change it
                />
                <div className="form-check mb-4">
                  <input
                    ...
                    onChange={this.onCheck} // if we check the box, we will call onCheck()
                    id="current"
                  />
